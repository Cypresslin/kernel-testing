...
class PDU():
    ...
    def cdu(s, outlet):
        retval = None
        retval = pexpect.spawn('ssh -o MACs=hmac-md5 -oKexAlgorithms=+diffie-hellman-group1-sha1 -oHostKeyAlgorithms=+ssh-dss enablement@%s' % s.__systems[s.target][outlet], timeout=600)
