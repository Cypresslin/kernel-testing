...
# mssh
#
def mssh(target, cmd, additional_ssh_options='', user=None, quiet=False, ignore_result=False):
    result, output = MShell.ssh(target, cmd, additional_ssh_options=additional_ssh_options, user=user, quiet=quiet, ignore_result=ignore_result)
