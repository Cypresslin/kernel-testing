                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <%
                                                                ...
                                                                link = "http://kernel.ubuntu.com/benchmarking/benchmark-results/iozone-fsync/%s__%s__%s/results-index.html" % (record['attributes']['platform']['hostname'], record['attributes']['kernel'], ts)
