...
rsync -arv -e "ssh -A bradf@192.168.1.9 ssh" $WORKSPACE/ jenkins@10.246.72.4:metrics/test-results/
$KT/test-results-announce --local ${data.job_name} $JENKINS_HOME/jobs/${data.job_name}/builds/${data.build_id} || true
            </command>
        </hudson.tasks.Shell>
