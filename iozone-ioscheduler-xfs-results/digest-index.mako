            ...
            <div class="dash-center">
                <div class="dash-center-content">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <%
                                                                ...
                                                                link = "http://kernel.ubuntu.com/benchmarking/benchmark-results/iozone-ioscheduler-xfs/%s__%s__%s/results-index.html" % (record['attributes']['platform']['hostname'], record['attributes']['kernel'], ts)
					...
					<!-- SERIES ------------------------------------------------------------ -->
                                                ...
                                                <table id="" width="100%" border="0">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <th align="left" width="40">&nbsp; deadline &nbsp;</th>
                                                            <th align="left" width="40">&nbsp; noop &nbsp;</th>
                                                            <th align="left" width="40">&nbsp; cfq &nbsp;</th>
                                                        </tr>
							   ...
							   lbase =  ""
							   ext4link = path.join(lbase, path.basename(scomp['path']), 'deadline/index.html')
							   ext3link = path.join(lbase, path.basename(scomp['path']), 'noop/index.html')
							   ext2link = path.join(lbase, path.basename(scomp['path']), 'cfq/index.html')
                                                         %>
                                                        <tr>
                                                          <td align="left">${ baseline }</td>
                                                          <td align="left">${ comparison }</td>
                                                          <td align="left"><a href="${ deadlinelink }">&nbsp; deadline &nbsp;</a></td>
                                                          <td align="left"><a href="${ nooplink }">&nbsp; noop &nbsp;</a></td>
                                                          <td align="left"><a href="${ cfqlink }">&nbsp; cfq &nbsp;</a></td>
                                                        </tr>
                                                        % endfor
                                                    </tbody>
                                                </table>
				    ...
				    <!-- LTS ------------------------------------------------------------ -->
							   ...
							   lbase =  ""
							   deadlinelink = path.join(lbase, path.basename(lcomp['path']), 'deadline/index.html')
							   nooplink = path.join(lbase, path.basename(lcomp['path']), 'noop/index.html')
							   cfqlink = path.join(lbase, path.basename(lcomp['path']), 'cfq/index.html')
                                                         %>
                                                        <tr>
                                                          <td align="left">${ baseline }</td>
                                                          <td align="left">${ comparison }</td>
				    ...
				    <!-- VERSIONS ------------------------------------------------------------ -->
							   ...
							   lbase =  ""
							   deadlinelink = path.join(lbase, path.basename(vcomp['path']), 'deadline/index.html')
							   nooplink = path.join(lbase, path.basename(vcomp['path']), 'noop/index.html')
							   cfqlink = path.join(lbase, path.basename(vcomp['path']), 'cfq/index.html')
                                                         %>
                                                        <tr>
                                                          <td align="left">${ baseline }</td>
                                                          <td align="left">${ comparison }</td>
